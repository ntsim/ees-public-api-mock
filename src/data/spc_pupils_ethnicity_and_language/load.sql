...
COPY data_facts FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/spc_pupils_ethnicity_and_language/data_facts.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
