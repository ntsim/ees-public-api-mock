...
CREATE TABLE data_facts(time_period_id UINTEGER NOT NULL, location_id UINTEGER NOT NULL, ssa_t1_desc UINTEGER NOT NULL, sex UINTEGER NOT NULL, ethnicity_group UINTEGER NOT NULL, notional_nvq_level UINTEGER NOT NULL, e_and_t_aims_enrolments VARCHAR, e_and_t_aims_ach VARCHAR);
