...
CREATE TABLE data_facts(time_period_id UINTEGER NOT NULL, location_id UINTEGER NOT NULL, phase_type_grouping UINTEGER NOT NULL, characteristic UINTEGER NOT NULL, fsm_eligibility UINTEGER NOT NULL, number_of_pupils VARCHAR, denominator VARCHAR, percent_of_pupils VARCHAR);
