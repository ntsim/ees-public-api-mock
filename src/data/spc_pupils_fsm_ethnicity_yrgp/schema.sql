...
CREATE SEQUENCE data_facts_seq INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 347831 NO CYCLE;
...
CREATE TABLE data_facts(id BIGINT PRIMARY KEY DEFAULT(nextval('data_facts_seq')), time_period_id INTEGER NOT NULL, location_id INTEGER NOT NULL, phase_type_grouping INTEGER NOT NULL, characteristic INTEGER NOT NULL, fsm_eligibility INTEGER NOT NULL, number_of_pupils VARCHAR, denominator VARCHAR, percent_of_pupils VARCHAR);
